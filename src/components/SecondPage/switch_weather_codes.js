...
import cloudywithrain from '../../icons/cloudywithrain.png';
import sunwithcloudwithrain from '../../icons/sunwithcloudwithrain.png';
...
export function switchCode (id){
    switch(id){
        ...
        case 232: 
         ...
         case 803:
         case 804:
         return <img src={brokenclouds} alt="brokenclouds"/>
